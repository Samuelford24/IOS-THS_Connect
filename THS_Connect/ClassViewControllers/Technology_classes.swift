...
/*
class Technology_classes: UITableViewController {
    let cellId = "cellId"
    ...
    func fetchClass() {
        ...
        Database.database().reference().child("Technology").observe(.childAdded, with: { (snapshot) in
            //print(userID)
