...
class Social_studies_classes: UITableViewController {
    ...
    func fetchClass() {
        ...
        Database.database().reference().child("Social Studies").observe(.childAdded, with: { (snapshot) in
            //print(userID)
